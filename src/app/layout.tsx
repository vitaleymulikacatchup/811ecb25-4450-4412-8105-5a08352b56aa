...
export const metadata: Metadata = {
  title: "SaaSFlow - Streamline Your Workflow Automation",
  description: "Powerful SaaS automation platform for teams. Integrate, automate, and grow faster with intelligent workflows. Start your free trial today.",
  keywords: "SaaS, workflow automation, productivity software, team collaboration, automation platform",
  metadataBase: new URL("https://saasflow.com"),
  alternates: {
    canonical: "https://saasflow.com"
  },
  openGraph: {
    title: "SaaSFlow - Workflow Automation Made Simple",
    description: "Automate your business processes and save hours every week. Trusted by 50K+ users worldwide.",
    siteName: "SaaSFlow",
    type: "website"
  },
  twitter: {
    ...
    description: "Powerful automation tools for modern teams"
  },
  robots: {
    index: true,
    follow: true
